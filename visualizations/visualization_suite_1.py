...
class FitnessDataProcessor:
    ...
    def calculate_percentile_fitness(self, lower=50, upper=100):
        fitness_per_gen = self.calculate_fitness_per_generation()
    ...
    def tanimoto_similarity(query_fp, all_fps):
        ...
        similarities = [DataStructs.TanimotoSimilarity(query_fp, fp) for fp in all_fps if fp is not None]
